  ...
  <div class="row">
    ...
    <div class="col-md-8" id="main_content">
      ...
      <table class="table-main">
        ...
        $query = "SELECT * FROM posts INNER JOIN users WHERE posts.uid=users.uid ORDER BY postid DESC";
        ...
        while($row = mysqli_fetch_assoc($query_run)){
          ...
          ?>
          <td><a href="javascript:DeletePost('<?php echo $row['postid']; ?>')"style='color:White' class="btn btn-danger"><span class='glyphicon glyphicon-trash' type="button"></span>Delete</a></td>
          <td><a href="javascript:UpdatePost('<?php echo $row['postid']; ?>');"style='color:White' class="btn btn-success"><span class='glyphicon glyphicon-trash' type="button"></span>Update</a></td>
          <?php 
          echo "</Tr>";
          ?>
          <?php
