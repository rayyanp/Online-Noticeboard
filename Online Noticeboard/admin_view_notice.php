...
<section id="container">
  <div class="row">
    ...
    <h3>Notices for you</h3><br>
      <form action="admin_view_notice.php" method="post">
      ...
      <!-- Table to display all the notices/posts -->
      <table class="table-main">
        ...
        <?php
        //Connects to the database, runs query and echos data from the database into the table.
