  ...
  if (!$errors) {
    ...
    $updatequery_run = mysqli_query($connection,$updatequery);
     if($updatequery_run){
       ...
       window.location.href = 'edit_admin_posts.php';
       </script>";
     }
     else{
       echo "<script>alert('Update failed...try again');
       window.location.href = 'update_admin_posts.php';
       </script>";
     }
...
<div class="col-md-8 m-auto block" id="main_content">
  ...
  <form action="" method="post" enctype="multipart/form-data">
    <div class="form-group form-group-position">
      <label>Title:</label>
      <input type="text" minlength="1" maxlength="120" class="form-control" name="title" value="<?php echo $title;?>" required>
    </div>
    <div class="form-group form-group-position">
      <label>Content:</label>
